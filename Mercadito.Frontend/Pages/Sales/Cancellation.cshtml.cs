...
public sealed class CancellationModel(ISalesApiAdapter salesApiAdapter, ILogger<CancellationModel> logger) : PageModel
{
    ...
    public async Task OnGetAsync()
    {
        ...
        if (metricsResult.Success && metricsResult.Data != null)
        {
            ...
            CancelledAmountTotal = metricsResult.Data.CancelledAmount;
        }
        else
        {
        ...
        else
        {
            ...
            logger.LogWarning("No se pudo cargar el historial de anulaciones: {Errors}", string.Join(" | ", salesResult.Errors));
        }
