...
namespace Mercadito.src.products.domain.dto
{
    ...
    {
        // Ahora lote numérico únicamente
        private const string BatchPattern = "^[0-9]+$";
        ...
        [Display(Name = "Lote")]
        [StringLength(40, ErrorMessage = "El lote no puede exceder 40 caracteres")]
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("El lote es obligatorio", [nameof(Batch)]);
            }
