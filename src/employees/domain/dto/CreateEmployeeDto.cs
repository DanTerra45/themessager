...
namespace Mercadito.src.employees.domain.dto
{
    public class CreateEmployeeDto
    {
        ...
        // Permitir +, dígitos, paréntesis, espacios y guiones (mín 7, máx 15)
        private const string ContactPattern = "^[+0-9()\\s-]{7,15}$";
        ...
        [StringLength(15, MinimumLength = 7, ErrorMessage = "El número de contacto debe tener entre 7 y 15 caracteres")]
        [RegularExpression(ContactPattern, ErrorMessage = "El número de contacto solo permite dígitos, +, paréntesis, espacios y guion")]
