...
namespace ServicioCatalogo.Application.Categories.Validation
{
    ...
    public abstract class CategoryValidator
    {
        ...
        private void ConfigureNameRules()
        {
            ...
            AddStringRule("Name",StringValidationRules.RegexMatch(@"^[\p{L}\s\.\-_,]+$", "El nombre solo permite letras, espacios y los caracteres . - _ ,"));
