...
namespace Mercadito.Sales.Api.Application.Sales.Ports.Input
{
    public interface ISalesQueryFacade
    {
        ...
        Task<Result<IReadOnlyList<SaleSummaryItem>>> GetRecentSalesAsync(
            int take = 20,
        ...
        Task<Result<DailyCashClosingReport>> GetDailyCashClosingReportAsync(DateOnly businessDate, CancellationToken cancellationToken = default);
