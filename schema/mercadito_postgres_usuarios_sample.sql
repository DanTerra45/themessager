...
(2, 'cajero', 'cajero1@local', 'sample-hash-cajero', 'Operator', 1, NULL, true, 'Active', NOW(), NOW()),
(3, 'auditor', 'auditor1@local', 'sample-hash-auditor', 'Auditor', 1, NULL, true, 'Active', NOW(), NOW())
