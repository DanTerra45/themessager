...
namespace ServicioEmpleados.Application.Employees.Ports.Output
{
    public interface IEmployeeRepository
    {
        ...
        Task<long> CreateAsync(Employee employee, long actorUserId, CancellationToken cancellationToken = default);
        Task<int> UpdateAsync(Employee employee, long actorUserId, CancellationToken cancellationToken = default);
