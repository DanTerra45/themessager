...
namespace Domain.Database
{
      ...
      where TOptions : IQueryOptions<TFields>
  {
    ...
    Task<Result<int>> CreateManyAsync<TRequest>(IEnumerable<TRequest> entities, TOptions? options, IDbTransaction? transaction = null, CancellationToken cancellationToken = default) where TRequest : class;
  }
}
